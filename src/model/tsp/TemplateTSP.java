...
public abstract class TemplateTSP implements TSP {
	 ...
	 */
	public void chercherEtAfficherMeilleureSolution(int tempsMaxMs, int nbSommets, double[][] graph, int[] duree) {
		chercheSolution(tempsMaxMs, nbSommets, graph, duree);
		...
		for (i = 1; i < nbSommets; i++) {
			...
			sommetSuivant = getMeilleureSolution(i);
			System.out.println("Aller de " + sommetCourant + " à " + sommetSuivant + " (pour un coût de " + graph[sommetCourant][sommetSuivant] + ", et une attente de " + duree[sommetSuivant] + " à l'arrivée)");
