...
public class TourCalculator {
	 ...
	 * 
	 * @param clusterNb
	 * @return a cluster list where each cluster either has one or zero delivery
	 */
	 ...
	 * 
	 * @param clusterList
	 * @return : whether or not a cluster list contains an empty cluster
	 */
	 ...
	 * @param                     remainingAdditionalDeliveries, represent the
	 *                            number of cluster not balanced with one more
	 *                            delivery
	 * @return : id of the nearest delivery from toMove, which belong to a not full,
	 *         not balanced cluster from currentClusters and which is from a
	 ...
	 * @param clusterNb : size of the cluster list. If clusterNb>deliveries s
	 *                size, only deliveries s size cluster will be return.
	 * @param epsilon : evaluate when to stop k-means algorithm
	 * @return : a set of balanced clusters.
	 */
 ...
 * 
 * @param clusters
 * @return the index of the biggest unbalanced cluster of a cluster list
 */
	 ...
	 * 
	 * @param clusters
	 * @return : HashMap<delivery index, cluster index>
	 */
...
/**
 * Calculate distance between two set of coordinate
 * @param intersectionData : first set of coordinate
 * @param centroidData : second set of coordinate
 * @return distance between centroidData and intersectionData
 */
