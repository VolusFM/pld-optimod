...
public abstract class ModelInterface {
    ...
    //
    // public static void setDeliveryMenCount(int count) {
    // System.out.println("setDeliveryMenCount to " + count); // FIXME do actual
    // implementation
    ...
    // }
    //
    // public static void createTour(int deliveryMan, List<Step> steps,
    // List<Delivery> deliveryPoints) {
    ...
    // }
    //
    // public static List<Cluster> kMeans(int clusterNb, List<Delivery>
    // deliveries, double epsilon){
