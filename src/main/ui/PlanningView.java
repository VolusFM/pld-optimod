...
public class PlanningView extends JPanel {
    ...
    private final String CANCEL_MODIFICATIONS_BUTTON = "Annuler la derni�re modification";
    ...
    /**
     * Create the graphical view for drawing the loaded plan with the scale s in the
     * specified window w.
     * 
     * @param w the window
     */
    ...
    /**
     * Method used to synchronize the textual view with the plan A click in the plan
     * select the corresponding rox of the planning if existing
     * 
